...
class Settings(BaseSettings):
    ...
    LIQUIDITY_STRUCTURE_TIMEFRAME: str = "4h"
    LIQUIDITY_STRUCTURE_LOOKBACK_DAYS: int = 14
    LIQUIDITY_SWEEP_TOLERANCE_PCT: float = 0.0015
    LIQUIDITY_CLUSTER_PCT: float = 0.0035
    LIQUIDATION_LEVERAGES: str = "5,10"
    LIQUIDITY_MAGNET_MAX_DISTANCE_PCT: float = 0.12
    LIQUIDITY_SWEEP_NEAR_PCT: float = 0.03
    DERIVATIVES_FUNDING_CROWDED_THRESHOLD: float = 0.0003
    DERIVATIVES_CACHE_TTL_SEC: int = 180
